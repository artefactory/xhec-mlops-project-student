...
from .predicting import predict, evaluate_model
...
def train_model_workflow(
    ...
    X, y = process_data(filepath=train_filepath, with_target=True)
...
def batch_predict_workflow(input_filepath: str,
...
if __name__ == "__main__":
    ...
    batch_predict_workflow(
        input_filepath = os.path.join(DATA_DIRPATH, "test_data.csv"),
        artifacts_filepath = MODELS_DIRPATH,
    )
