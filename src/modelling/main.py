...
import pandas as pd 
import numpy as np 
from preprocessing import compute_target, encode_categorical_cols, scale, extract_x_y
from utils import load_pickle, save_pickle
from training import train_model
import os 

def main(trainset_path: str, select_train=True) -> None:
    ...
    model_save_path = os.path.join(os.path.dirname(os.path.dirname(script_dir), "web_dev", "loaded_model.pkl"))  # Save to the "web_dev" directory
